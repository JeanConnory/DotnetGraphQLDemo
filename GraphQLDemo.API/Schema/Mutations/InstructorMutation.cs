...
public class InstructorMutation
{
    ...
    public async Task<InstructorResult> CreateInstructor([UseFluentValidation, UseValidator<InstructorTypeInputValidator>] InstructorTypeInput instructorInput, 
        [ScopedService] SchoolDbContext context, [Service] ITopicEventSender topicEventSender)
    {
    ...
    [Authorize]
    [UseDbContext(typeof(SchoolDbContext))]
    public async Task<InstructorResult> UpdateInstructor(Guid id, InstructorTypeInput instructorInput,
        [UseFluentValidation, UseValidator<InstructorTypeInputValidator>] InstructorTypeInput instructorTypeInput, [ScopedService] SchoolDbContext context)
    {
